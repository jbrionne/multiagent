...
class KnowledgeStorage(KnowledgeStorage):
    """
    ...
    def initialize_knowledge_storage(self):
        ...
        try:
            chroma_client = chromadb.HttpClient(host=self.host, port=self.port, settings=Settings(anonymized_telemetry=False, allow_reset=True))
