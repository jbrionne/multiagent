...
class MyCodeInterpreterSchema(BaseModel):
    """Input for MyCodeInterpreterTool."""
...
class MyCodeInterpreterTool(BaseTool):
    name: str = "Direct Code Interpreter"
    description: str = "Interprets Python3 code strings with a final print statement."
    args_schema: Type[BaseModel] = MyCodeInterpreterSchema
